...
<input type="Text" name="hotelName" id="hnm" value="${param.hotelName }" readonly>
...
<input type="text" name="ciy" id="cit" value="${param.city }" readonly>

<label for="zp">Zip:</label>
<input type="number" name="zip" id="zp" value="${param.zip }" readonly>

<label for="tnor">Total No of Rooms:</label>
<input type="number" name="totalNoOfRooms" id="tnor" value="${param.totalNoOfRooms}" readonly>

<label for="ar">Available Rooms:</label>
<input type="number" name="availableRooms" id="ar" value="${param.availableRooms }" readonly>
<br>
